 ...
 */
public class ItemModelTypeAdapter extends TypeAdapter<ItemModel> {
    ...
    @Override
    public void write(JsonWriter writer, ItemModel model) throws IOException {
        writer.beginObject();
    ...
    @Override
    public ItemModel read(JsonReader reader) throws IOException {
        String parent = null;
        Display display = null;
        Model.Textures textures = null;
        @NotNull ItemModel.GuiLight guiLight = ItemModel.GuiLight.SIDE;
        ...
        while (reader.hasNext()) {
            switch (reader.nextName()) {
                ...
                case "gui_light" -> guiLight = ItemModel.GuiLight.valueOf(reader.nextString());
                case "textures" -> {
